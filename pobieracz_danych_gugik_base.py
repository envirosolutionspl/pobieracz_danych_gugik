...
class Ui_PobieraczDanychDockWidgetBase(object):
    def setupUi(self, PobieraczDanychDockWidgetBase):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -264, 405, 1183))
        ...
        self.gridLayout_31.addWidget(self.label_17, 8, 0, 1, 1)
        self.label_131 = QtWidgets.QLabel(self.nmt_filter_groupBox)
        self.label_131.setObjectName("label_131")
        self.gridLayout_31.addWidget(self.label_131, 6, 0, 1, 1)
        self.label_111 = QtWidgets.QLabel(self.nmt_filter_groupBox)
        ...
        self.gridLayout_31.addWidget(self.nmt_pixelFrom_lineEdit, 6, 1, 1, 1)
        ...
        self.gridLayout_31.addWidget(self.nmt_pixelTo_lineEdit, 7, 1, 1, 1)
        self.label_141 = QtWidgets.QLabel(self.nmt_filter_groupBox)
        self.label_141.setObjectName("label_141")
        self.gridLayout_31.addWidget(self.label_141, 7, 0, 1, 1)
        self.nmt_source_cmbbx = QtWidgets.QComboBox(self.nmt_filter_groupBox)
        self.nmt_source_cmbbx.setObjectName("nmt_source_cmbbx")
        self.nmt_source_cmbbx.addItem("")
        self.nmt_source_cmbbx.addItem("")
        self.nmt_source_cmbbx.addItem("")
        self.gridLayout_31.addWidget(self.nmt_source_cmbbx, 4, 1, 1, 1)
        ...
        self.nmt_full_cmbbx.addItem("")
        self.nmt_full_cmbbx.addItem("")
        self.gridLayout_31.addWidget(self.nmt_full_cmbbx, 5, 1, 1, 1)
        ...
        self.gridLayout_31.addWidget(self.label_18, 9, 0, 1, 1)
        ...
        self.gridLayout_31.addWidget(self.nmt_mhFrom_lineEdit, 8, 1, 1, 1)
        ...
        self.gridLayout_31.addWidget(self.nmt_mhTo_lineEdit, 9, 1, 1, 1)
...
"nieodpłatnie przez GUGiK."))
        ...
        self.nmt_source_cmbbx.setItemText(0, _translate("PobieraczDanychDockWidgetBase", "wszystkie"))
        self.nmt_source_cmbbx.setItemText(1, _translate("PobieraczDanychDockWidgetBase", "Zdj. cyfrowe"))
        self.nmt_source_cmbbx.setItemText(2, _translate("PobieraczDanychDockWidgetBase", "Zdj. analogowe"))
