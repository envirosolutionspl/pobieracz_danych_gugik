...
class Ui_PobieraczDanychDockWidgetBase(object):
    def setupUi(self, PobieraczDanychDockWidgetBase):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 418, 772))
...
"nieodpłatnie przez GUGiK."))
        ...
        self.orto_filter_groupBox.setTitle(_translate("PobieraczDanychDockWidgetBase", "filtruj wyniki"))
        ...
        self.label_2.setText(_translate("PobieraczDanychDockWidgetBase", "Wybierz warstwę"))
        self.fromLayer_btn.setText(_translate("PobieraczDanychDockWidgetBase", "Pobierz dane w zasięgu wybranej warstwy"))
